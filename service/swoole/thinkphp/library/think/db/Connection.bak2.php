...
abstract class Connection
{
     ...
     * @throws Exception
     */
    public function connectBak(array $config = [], $linkNum = 0, $autoConnection = false)
    {
...
//                var_dump($params);
//                $this->links[$linkNum] = new PDO($config['dsn'], $config['username'], $config['password'], $params);
                $this->links[$linkNum] = PDOPool::instance()->get();
    ...
    {
        $this->linkID && PDOPool::instance()->put($this->linkID);
    }
...
//            $this->free();
    ...
    public function close()
    {
        ...
        $this->linkWrite = null;
        $this->linkRead  = null;
        foreach ($this->links as $pdo) {
            PDOPool::instance()->put($pdo);
        }
        $this->links = [];
        // 释放查询
        $this->free();
